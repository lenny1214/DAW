...
En otras palabras, la propiedad value es la suma de todos los valores ingresados por el usuario 
con el valor inicial startingValue.
...
this.read = function() {
    this.value += +prompt("Introduzca un número sil vou plait");
};
}
